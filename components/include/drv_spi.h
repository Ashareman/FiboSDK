...
int32_t fibo_spi_init(drvSpiConfig_t cfg, SPIHANDLE * spiFd);
int32_t fibo_spi_uninit(SPIHANDLE * spiFd);
int32_t fibo_spi_write(SPIHANDLE spiFd, SPI_IOC spiIoc, void * sendaddr, uint32_t size);
int32_t fibo_spi_read(SPIHANDLE spiFd, SPI_IOC spiIoc, void * sendaddr, void * readaddr, uint32_t size);
int32_t fibo_spi_pin_ctrl(SPIHANDLE spiFd, drvSpiPinCtrl pinctrl, drvSpiPinState pinstate);
#endif
#ifdef __cplusplus
}
#endif
