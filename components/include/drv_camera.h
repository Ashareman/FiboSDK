...
typedef struct sensorInfo
{
    ...
    uint8_t pixel_byte;   // byte size of one pixel, default(which is 0) as 2 bytes
#endif
} sensorInfo_t;

extern sensorInfo_t gc0310Info;
extern sensorInfo_t gc032aInfo;
extern sensorInfo_t bf30a2Info;
extern sensorInfo_t Bf20a6Info;
extern sensorInfo_t sc031Info;
