...
typedef bt_status_t (*scan_broadcast_cb)(void* param,uint8 adv_len);

typedef struct {
	int scan_res_data_set_flag;
	int scan_res_data_len;
	char scan_res_data[64];
	UINT8 adv_enabled;
	scan_broadcast_cb scan_broadcast_cb_f;
}customer_param_ext_t;
