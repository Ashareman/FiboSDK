...
#ifdef CONFIG_FIBOCOM_BASE
#define ERR_AT_CME_FTP_ACTIVE 64
#endif
...
#define ERR_AT_CME_OTHOR_ERROR 981
...
#if (defined CONFIG_FIBOCOM_ALIOS) || (defined CONFIG_FIBOCOM_ALIOS_JSOPENCPU)
#define ERR_AT_CME_ALIYUN_MQTT_STATE_INVALID 1020
#endif
...
#ifdef CONFIG_FIBOCOM_TENCENT_CLOUD_RABBIT
#define ERR_AT_CMS_SIM_NOT_OPERATOR  540   //SIM card does not support this operator
#define ERR_AT_CMS_SIM_CHEKA_OPERATOR  541
#define ERR_AT_CMS_SIM_AUTO_CARD  542
#define ERR_AT_CMS_SIM_RABBIT_RUN_ERR  543
#define ERR_AT_CMS_SIM_NOTU_SUPPORT  544
...
void atCmdFiboOdmRespInfoNText(atCmdEngine_t *engine, const char *text, size_t length);
...
#ifdef CONFIG_FIBOCOM_MC617
void atCipCmdRespInfoNText(atCmdEngine_t *engine, const char *text, size_t length);
void atCipCmdRespOKText(atCmdEngine_t *engine, const char *text);
void atCipCmdRespUrcText(atCmdEngine_t *engine, const char *text);
#endif
