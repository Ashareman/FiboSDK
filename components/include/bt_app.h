...
bool app_bt_hfp_dis_audio(void);
a2dp_device_info_t *bt_a2dp_get_device(void);
bt_status_t ble_connect_cancel(bdaddr_t *address);
void fibo_ble_adv_set(void);
#ifdef CONFIG_FIBOCOM_BASE
char *app_ble_white_list_read(void);
UINT8 app_ble_white_list_size(void);
#endif
