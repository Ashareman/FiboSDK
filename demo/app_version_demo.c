...
{
	if(!strcmp((char *)data, "AT+APP\r\n"))
    {
        char buff[256] = { 0 };
        fibo_get_version_info(buff, sizeof(buff)-1);
        strcat(buff, "\r\n\r\nOK\r\n");
        fibo_hal_uart_put(uart_port, (UINT8 *)buff, strlen(buff));
        OSI_PRINTFI("uartapi fibo_hal_uart_put len=%d, buff=%s", strlen(buff), (char *)buff);
    }
...
static void prvThreadEntry(void *param)
{
    ...
    char ver[] = "7180051BB0105";
    fibo_set_app_version(ver);
