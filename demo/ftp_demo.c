...
void ftp_read()
{
    char *ftppath = "/data/500K.txt";
    char *localpath = "/FFS/500K.txt";
...
static void sig_res_callback(GAPP_SIGNAL_ID_T sig, va_list arg)
{
	...
	{
        OSI_LOGI(0, "write success");
		
    }
	break;
	case GAPP_SIG_FTPREAD_SUCCESS:
	{
		OSI_LOGI(0, "read success");
		FTP_STATUS = 2;
	}
	break;
    case GAPP_SIG_FTPREAD_FALI:
	{
		OSI_LOGI(0, "read failed.");
        //fibo_taskSleep(3000);
		FTP_STATUS = 2;
	}
	break;
	...
	{
		OSI_LOGI(0, "ftpclose success");
	}
    break;
    case GAPP_SIG_FTPOPEN_FAIL:
    {
        OSI_LOGI(0, "ftppeon failed.");
        fibo_ftp_open("47.110.234.36","ftpuser1","test");
    }
    break;
    default:
    {
